        ...
        device = {
            ...
            "cmps": {
                ...
                "api_calls": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service_name, "api_calls"),
                ...
                "rate_limited": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service_name, "rate_limited"),
                ...
                "refresh_interval": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service_name, "refresh_interval"),
                ...
                "rescan_interval": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service_name, "rescan_interval"),
                ...
                "boost_interval": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service_name, "boost_interval"),
