...
class GoveeMixin:
    ...
    async def build_humidifier(self: Govee2Mqtt, humidifier: dict[str, Any]) -> str:
        ...
        cmps["power"] = {
            ...
            "obj_id": self.mqtt_helper.obj_id(humidifier["deviceName"], "power"),
            "stat_t": self.mqtt_helper.stat_t(device_id, "switch", "power"),
            "cmd_t": self.mqtt_helper.cmd_t(device_id, "power"),
            "device_class": "switch",
            "icon": "mdi:power",
        ...
        if device_has.get("warmMistToggle", False):
            cmps["warm_mist"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(humidifier["deviceName"], "warm_mist"),
        ...
        if device_has.get("nightlightToggle", False) and nightlight_options:
            cmps["night_light"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(humidifier["deviceName"], "night_light"),
