...
class GoveeMixin:
    ...
    async def build_air_purifier(self: Govee2Mqtt, air_purifier: dict[str, Any]) -> str:
        ...
        cmps: dict[str, dict[str, Any]] = {
            "power": {
                ...
                "obj_id": self.mqtt_helper.obj_id(air_purifier["deviceName"], "air_purifier"),
        ...
        if device_has.get("workMode", False) and work_mode_options:
            cmps["work_mode"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(air_purifier["deviceName"], "work_mode"),
        ...
        if device_has.get("filterLifeTime", False):
            cmps["filter_life"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(air_purifier["deviceName"], "filter_life"),
        ...
        if device_has.get("airQuality", False):
            cmps["air_quality"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(air_purifier["deviceName"], "air_quality"),
    ...
    async def build_humidifier(self: Govee2Mqtt, humidifier: dict[str, Any]) -> str:
        ...
        cmps["power"] = {
            ...
            "obj_id": self.mqtt_helper.obj_id(humidifier["deviceName"], "humidifier"),
            "stat_t": self.mqtt_helper.stat_t(device_id, "switch", "power"),
            "cmd_t": self.mqtt_helper.cmd_t(device_id, "power"),
            "device_class": "switch",
            "icon": "mdi:power",
        ...
        if device_has.get("humidity", False):
            cmps["humidity"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(humidifier["deviceName"], "humidity"),
        ...
        if device_has.get("warmMistToggle", False):
            cmps["warm_mist"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(humidifier["deviceName"], "switch"),
        ...
        if device_has.get("workMode", False) and work_mode_options:
            cmps["work_mode"] = {
                ...
                "name": "Work Mode",
                "uniq_id": self.mqtt_helper.dev_unique_id(device_id, "work_mode"),
                "obj_id": self.mqtt_helper.obj_id(humidifier["deviceName"], "work_mode"),
                "stat_t": self.mqtt_helper.stat_t(device_id, "select", "work_mode"),
                "cmd_t": self.mqtt_helper.cmd_t(device_id, "select", "work_mode"),
                "options": work_mode_options,
                "icon": "mdi:water-pump",
        ...
        if device_has.get("nightlightToggle", False) and nightlight_options:
            cmps["night_light"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(humidifier["deviceName"], "nightlight_scene"),
    ...
    async def build_kettle(self: Govee2Mqtt, kettle: dict[str, Any]) -> str:
        ...
        cmps: dict[str, dict[str, Any]] = {
            "power": {
                ...
                "obj_id": self.mqtt_helper.obj_id(kettle["deviceName"], "kettle"),
                "stat_t": self.mqtt_helper.stat_t(device_id, "switch", "power"),
                "cmd_t": self.mqtt_helper.cmd_t(device_id, "power"),
                "device_class": "switch",
                "icon": "mdi:kettle",
        ...
        if device_has.get("sensorTemperature", False):
            cmps["temperature"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(kettle["deviceName"], "temperature"),
        ...
        if device_has.get("sliderTemperature", False):
            cmps["target_temperature"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(kettle["deviceName"], "target_temperature"),
        ...
        if device_has.get("workMode", False) and work_mode_options:
            cmps["work_mode"] = {
                ...
                "name": "Work Mode",
                "uniq_id": self.mqtt_helper.dev_unique_id(device_id, "work_mode"),
                "obj_id": self.mqtt_helper.obj_id(kettle["deviceName"], "work_mode"),
                "stat_t": self.mqtt_helper.stat_t(device_id, "select", "work_mode"),
                "cmd_t": self.mqtt_helper.cmd_t(device_id, "select", "work_mode"),
                "options": work_mode_options,
    ...
    def build_light_components(
            ...
            match cap["instance"]:
                ...
                case "gradientToggle":
                    components["gradient"] = {
                        ...
                        "obj_id": self.mqtt_helper.obj_id(device_name, "gradient"),
                ...
                case "dreamViewToggle":
                    components["dreamview"] = {
                        ...
                        "obj_id": self.mqtt_helper.obj_id(device_name, "dreamview"),
        ...
        for instance, scene_data in dynamic_scene_caps.items():
            ...
            components[scene_key] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(device_name, scene_key),
        ...
        if segment_range and (has_segment_brightness or has_segment_color):
            ...
            components["segment_index"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(device_name, "segment_index"),
            ...
            if has_segment_brightness and segment_brightness_range:
                ...
                components["segment_brightness"] = {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(device_name, "segment_brightness"),
            ...
            if has_segment_color and segment_color_range:
                ...
                components["segment_rgb"] = {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(device_name, "segment_rgb"),
        ...
        if has_music_capability and music_mode_options:
            ...
            components["music_mode"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(device_name, "music_mode"),
            ...
            components["music_sensitivity"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(device_name, "music_sensitivity"),
            ...
            if music_auto_color_values:
                components["music_auto_color"] = {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(device_name, "music_auto_color"),
            ...
            if music_rgb_supported:
                components["music_rgb"] = {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(device_name, "music_rgb"),
        ...
        if scenes:
            ...
            if api_scene_options:
                ...
                components["light_scene"] = {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(device_name, "light_scene"),
