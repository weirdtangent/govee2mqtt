...
class GoveeServiceProtocol(Protocol):
    ...
    async def build_light(self, device: dict[str, Any]) -> str: ...
    async def build_sensor(self, device: dict[str, Any]) -> str: ...
    ...
    async def handle_device_topic(self, components: list[str], payload: dict[str, Any]) -> None: ...
    async def handle_homeassistant_message(self, payload: str) -> None: ...
    async def handle_service_message(self, handler: str, message: str) -> None: ...
    ...
    async def refresh_device_states(self, device_id: str, data: dict[str, Any] = {}) -> None: ...
