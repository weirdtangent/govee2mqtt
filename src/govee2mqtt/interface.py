...
class GoveeServiceProtocol(Protocol):
    ...
    async def build_component(self, device: dict[str, Any]) -> list[str]: ...
    ...
    async def build_group(self, group: dict[str, Any]) -> str: ...
    async def get_light_scenes(self, device_id: str) -> list[dict[str, Any]]: ...
    async def build_light(self, light: dict[str, Any]) -> str: ...
    async def build_sensor(self, sensor: dict[str, Any]) -> list[str]: ...
    ...
    async def prepare_device(self, device: dict[str, Any], raw_id: str, device_id: str, type: str, state: dict[str, Any] | None = None) -> None: ...
